...
```{r recoding}
#Generating keys
key1 <- c("1\nWould get less thought-through" = 1,
          "4\nWould not change" = 4,
          "7\nWould get more thought-through" = 7,
          "I do not know" = 99,
          "Not applicable" = 99,
          "2" = 2, "3" = 3, "5" = 5, "6" = 6)
...
key7 <- c("1\nGot less thought-through" = 1,
          "4\nDid not change" = 4,
          "7\nGot more thought-through" = 7,
          "I do not know" = 99,
          "Not applicable" = 99,
          "2" = 2, "3" = 3, "5" = 5, "6" = 6)
...
recoded_data <- filtered_data %>% 
  mutate(control_hypothesis = recode(control_hypothesis, !!!key1),
         control_design = recode(control_design, !!!key1),
         control_analysis = recode(control_analysis, !!!key1),
         control_rdm = recode(control_rdm, !!!key1),
         control_workflow = recode(control_workflow, !!!key1),
         control_collab = recode(control_collab, !!!key2),
         control_preparatory = recode(control_preparatory, !!!key3),
         control_duration = recode(control_duration, !!!key4),
         control_stress = recode(control_stress, !!!key5),
         control_qrp = recode(control_qrp, !!!key6),
         prereg_hypothesis = recode(prereg_hypothesis, !!!key7),
         prereg_design = recode(prereg_design, !!!key7),
         prereg_analysis = recode(prereg_analysis, !!!key7),
         prereg_rmd = recode(prereg_rmd, !!!key7),
         prereg_workflow = recode(prereg_workflow, !!!key7),
         prereg_collab = recode(prereg_collab, !!!key8),
         prereg_preparatory = recode(prereg_preparatory, !!!key9),
         prereg_duration = recode(prereg_duration, !!!key10),
         prereg_stress = recode(prereg_stress, !!!key11),
         prereg_qrp = recode(prereg_qrp, !!!key6),
         recommend = recode(recommend, !!!key6))
```
