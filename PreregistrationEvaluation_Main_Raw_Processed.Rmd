...
```{r fields}
fields_old <- tidy_data %>% 
  select(response_id, field) %>% 
  add_column(final_field = NA)

writexl::write_xlsx(fields_old, "Data/Main/Processed/Import/PreregistrationEvaluation_Fields_Old.xlsx")
...
writexl::write_xlsx(type_other, "Data/Main/Processed/Import/PreregistrationEvaluation_Type_Other.xlsx")
```
