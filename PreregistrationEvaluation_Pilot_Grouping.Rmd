...
```{r}
write_xlsx(raw_separate, "Data/Pilot/Processed/Export/PreregistrationEvaluation_Pilot_Separating_data.xlsx")
```
...
```{r}
raw_separated <- read_tsv("Data/Pilot/Processed/Import/PreregistrationEvaluation_Pilot_Separated_data.tsv")
```
...
```{r}
write_xlsx(raw_code, "Data/Pilot/Processed/Export/PreregistrationEvaluation_Pilot_Coding_data.xlsx")
```

# Import data

```{r}
raw_coded <- read_tsv("Data/Pilot/Processed/Import/PreregistrationEvaluation_Pilot_Coded_data.tsv")
```
...
```{r}
write_xlsx(raw_group, "Data/Pilot/Processed/Export/PreregistrationEvaluation_Pilot_Grouping_data.xlsx")
```

# Import data

```{r}
raw_grouped <- read_tsv("Data/Pilot/Processed/Import/PreregistrationEvaluation_Pilot_Grouped_data.tsv")
```
...
```{r}
write_xlsx(raw_items, "Data/Pilot/Processed/Export/PreregistrationEvaluation_Pilot_ItemCreation_data.xlsx")
```
...
write_xlsx(raw_validation, "Data/Pilot/Processed/Export/PreregistrationEvaluation_Pilot_Validation_data.xlsx")
